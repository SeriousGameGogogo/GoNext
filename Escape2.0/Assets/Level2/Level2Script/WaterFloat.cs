...
public class WaterFloat : MonoBehaviour
{
    ...
    public float force1Show;

    public float forceTotalShow;
    public float boatPositionShow;
    ...
    public void FixedUpdate()
    {
        ...
        Rigidbody.AddForce(gravity * Mathf.Clamp(Mathf.Abs(WaterLine + 2.0f - Center.y),0,5));
        force1Show = WaterLine + 2.0f - Center.y;
        forceTotalShow = Mathf.Clamp(Mathf.Abs(WaterLine + 2.0f - Center.y),0,25);
        boatPositionShow = Rigidbody.position.y;
        //rotation
        if (pointUnderWater)
        {
            //attach to water surface
